...
```yaml
  ...
  # 보통 topic 단위로 관리되며, 그 기본값을 server.properties에서 지정가능
  # 기존 topic의 RF는 여기서 변경불가하며, kafka-reassign-partitions.sh 스크립트로 수동변경 가능
  ...
  # 모든 토픽의 minISR기본값 (커스텀값 있는 토픽 제외) (default: 1)
